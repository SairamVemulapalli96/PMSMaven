<%@ page import="java.util.List, java.util.ArrayList,com.rama.pms.bo.Tenant" %>
...
<h1></h1>
		...
		<form id="deleteForm" name="DeleteMyTenantProfileForm" action="DeletMyTenantProfile" method="post">
		<table  border="1">
		<thead>
					<tr>
