<%@ page import="java.util.List, java.util.ArrayList,com.rama.pms.bo.Property" %>
<%@include file="dynamicmenu.jsp" %>
		...
		%>
				<div class=errorMsg>Sorry, you don't have any registered properties yet.</div>
		<%
			} else {
		%>
		<table border="1">
		...
		<%				
			for(Property property : propertyList)
			{
				...
				"<a href='ViewMyProperty?pid=" + property.getPId() + "'> View " + "</a> | " +
